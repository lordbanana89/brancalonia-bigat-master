...
class BrancaloniaTavernEntertainment {
  ...
  static initialize() {
    ...
    try {
      ...
      console.log('✅ Brancalonia | Tavern Entertainment inizializzato con successo');
    } catch (error) {
      console.error('❌ Errore inizializzazione Tavern Entertainment:', error);
  ...
  static setupTavernGames() {
    ...
    console.log('🎲 Giochi da taverna configurati');
  }
  ...
  static handleCanvasReady() {
    try {
      ...
      console.error('Errore canvas ready:', error);
    }
  }
  ...
  static addTavernControls(controls) {
    try {
      ...
      console.error('Errore aggiunta controlli taverna:', error);
    }
  }
  ...
  static async toggleTavernMode() {
    try {
      ...
      console.error('Errore toggle taverna:', error);
    }
  }
  ...
  static handleGoldUpdate(actor, changes, options, userId) {
    try {
      ...
      console.error('Errore tracking oro:', error);
    }
  }
  ...
  static async rollBagordiResult(actor, goldSpent) {
    try {
      ...
      console.error('Errore risultato bagordi:', error);
  ...
  static async applyBagordiEffects(actor, result, goldSpent) {
    try {
      ...
      console.error('Errore applicazione effetti bagordi:', error);
    }
  }
