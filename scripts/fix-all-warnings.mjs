...
const DEPRECATED_PATTERNS = [
  ...
  },
  {
    ...
    replacement: 'foundry.utils.foundry.utils.mergeObject(',
  ...
  },
  {
    ...
    replacement: 'foundry.utils.foundry.utils.getProperty(',
    description: 'getProperty -> foundry.utils.getProperty'
  },
  {
    pattern: /setProperty\(/g,
    replacement: 'foundry.utils.foundry.utils.setProperty(',
    description: 'setProperty -> foundry.utils.setProperty'
  },
  {
    pattern: /hasProperty\(/g,
    replacement: 'foundry.utils.foundry.utils.hasProperty(',
